    ...
    <nav class="navbar">
      ...
      <div class="item search right" tabindex="0">
        <div class="search-group">
          ...
          <input type="text" />
          <img src="https://media.istockphoto.com/vectors/search-icon-magnifying-glass-in-simple-design-search-vector-icon-for-vector-id1171564262?k=20&m=1171564262&s=170667a&w=0&h=u7m85LQWQYQnjd4zKzbxICRBNwoo3-4JhKME2Yrsl_0=" alt="sorry" />
        </div>
      </div>
